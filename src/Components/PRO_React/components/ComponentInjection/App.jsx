...
export default function App() {
  return (
    <div className="injection-app">
      <h1><span>&lt;Component Injection&gt;</span> Pattern</h1>
      <p className="description">Pass components կամ render functions տարբեր վեներացիաների համար</p>
      <hr />
      ...
      <div className="injection-demo">
        ...
        <div className="demo-section">
          <h2>3. Card Grid</h2>
          <CardList items={items} renderCard={item => (
      ...
      <div className="resource">
        <p>📚 <a href="https://www.patterns.dev/react/component-injection-pattern" target="_blank" rel="noopener noreferrer">Learn more</a></p>
      </div>
    </div>
  );
}
