////////////////////////////////////////////////////////////////////////////////
// - Router - սահմանում է մի շարք երթուղիներ(href) և երբ հարցում է գալիս Router-ը կատարում է URL հարցման և երթուղու համեմատություն։
//	Եվ եթե որևիցե ՛href՛ համապատասխանում է URL հարցման-ը, ապա այդ երթուղին ընտրվում է հարցումը մշակելու համար:
// - <Route/> Կոմպոնենտը  React Router-ի գլխավոր կառուցողական բլոկն է.Route-ը օբյեկտ է, որը ներկաըացնում է ամեն մի լինկը,
//	ունի մի շարք ատրիբուտներ։Այստեղ օգտագործված են 2-ը
...
// - Switch -  Նաև երթուղի ընտրելու համար սահմանվում է  Switch օբյեկտը. Այն թույլ է տալիս ընտրել գտած առաջին երթուղին և օգտագործել
//	այն հարցման մշակման համար։ Առանց այս օբյեկտի, Router-ը տեսականորեն կարող է օգտագործել մի քանի երթուղի՝ մեկ հարցումը 
//	մշակելու համար,եթե դրանք համապատասխանում են հարցման տողին
