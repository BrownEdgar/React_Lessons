...
// export default withRouter(Header) - Անց է կացնում կոմպոնենտը "Իր միջով",
// ավելացնելով նրա  props-ում history... Արվում է նրա համար, որ մենք այստեղից
// կարողանանք նավիգացիա կառուցել(օր․ 'home' տանող կոճակ )
// //////////////////////////////////////////////////////////////////////////////
...
function About(props) {
    ...
    return (
        <div>
            <h1>{props.name}</h1>
            <h2>id: {id}
                Name: {name}</h2>; {/* <img src="./photo-React.jpg" alt="Nkar"/> */}
            {/* //մյուս դասի թեմա */}
