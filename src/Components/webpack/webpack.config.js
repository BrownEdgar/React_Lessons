...
module.exports = {
  ...
  plugins: [
    new webpack.EnvironmentPlugin({
      NODE_ENV: NODE_ENV, // եթե չի գտնվել import.meta.env.NODE_ENV-ն
      DEBUG: false
    })
  ],
...
//new webpack.EnvironmentPlugin -Թույլ է տալիս "User"-ին հասանելի դարձնել մեր "import.meta.env"-ում գտնվող գաղտնի փոփոխականները՛
